  ...
  return (
    <div className="rounded-xl border border-slate-700 bg-slate-900 overflow-hidden">
      ...
      <div className="p-4 space-y-4 overflow-y-auto max-h-[calc(100vh-300px)]">
        ...
        <DetailField
          label="Previous Hash"
          value={record.previousHash ?? 'Genesis record (no parent)'}
          mono={!!record.previousHash}
        />
        ...
        {/* Signature */}
        {record.signature && (
          <DetailField label="Signature" value={record.signature} mono />
        )}
...
function DetailField({
  ...
  return (
    <div>
      ...
      <p
        className={`mt-0.5 text-sm text-slate-300 break-all ${

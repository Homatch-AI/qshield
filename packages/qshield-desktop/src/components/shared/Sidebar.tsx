  ...
  const iconPaths: Record<string, React.ReactNode> = {
    ...
    shield: (
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 2.272A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751A11.959 11.959 0 0112 2.272z"
      />
    ),
    'shield-check': (
      <path
    ...
    'user-shield': (
      <>
        ...
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M17.25 13.5l.884.884a.75.75 0 001.06 0l1.806-1.806"
        />
      </>
    ),
    settings: (
